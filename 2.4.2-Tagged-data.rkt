...
(define (real-part z) (cond ((rectangular? z) (real-part-rectangular (contents z))) ;; SELECTORS
...
(define (make-from-real-imag x y) (make-from-real-imag-rectangular x y)) ;; CONSTRUCTORS
